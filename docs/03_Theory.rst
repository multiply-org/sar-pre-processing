...
Precise orbit information can have a high influence on the quality of several different preprocessing steps. Therefore, it is always preferable to use the most accurate orbit information that is available.
